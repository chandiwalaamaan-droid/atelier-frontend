                ...
                <div className="flex-1 min-w-0">
                  ...
                  {c.isPublic && (
                    <span className="inline-flex items-center gap-2 mt-0.5">
                      <span className="inline-block text-[10px] text-gold/80 border border-gold/30 rounded-full px-2 py-0.5">
                        Shared
                      </span>
                      <span className="text-[10px] text-parchment/40 flex items-center gap-1.5">
                        <span title="Views">👁 {formatCount(c.viewCount ?? 0)}</span>
                        <span title="Favorites">♥ {formatCount(c.favoriteCount ?? 0)}</span>
                      </span>
                    </span>
                  )}
