          ...
          <main className="flex-1 flex flex-col min-h-0 relative">
            <div className="flex-1 flex items-center justify-center">
              <div className="text-center max-w-sm px-4">
                <p className="text-parchment/60 mb-4">{loadError}</p>
                <button
                  onClick={retryLoad}
                  className="text-gold hover:text-gold-light focus-ring rounded px-4 py-2 transition-colors"
                >
                  Try again
                </button>
              </div>
